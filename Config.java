...
public final class Config
{
	...
	public static final String SKIN_ENHANCEMENTS_FILE = "./config/custom/SkinEnhancements.ini";
	public static final String BOSS_EVENT_INSTANCED = "./config/custom/events/BossEvent.ini";
	...
	public static final String DUNGEON_REWARD_FILE = "./config/custom/events/Dungeon_Html_Reward.ini";	
	...
	public static final String SUPERMONSTER_FILE = "./config/custom/events/SuperMonster.ini";
	...
	public static final String AUTO_FARM_FILE = "./config/custom/AutoFarm.ini";
	...
	public static boolean ALLOW_ZONE_NAME;
	...
	public static int SKIN_ANIMATION_TIME;
	public static int SKIN_SKILL_ID;
	public static boolean SKIN_ENABLE_ANIMATIONS;
	public static boolean SKIN_ENABLE_ENHANCED_EFFECTS;
	public static boolean SKIN_ENABLE_SOUNDS;
	public static int SKIN_EFFECT_INTENSITY;
	public static boolean SKIN_ENABLE_MESSAGES;
	public static String SKIN_TRANSFORMATION_MESSAGE;
	public static int SKIN_COOLDOWN_TIME;
	public static boolean SKIN_ENABLE_ZONE_RESTRICTIONS;
	public static String SKIN_ALLOWED_ZONES;
	public static boolean SKIN_ENABLE_FOR_GM;
	public static boolean SKIN_ENABLE_FOR_AIO;
	...
	public static String TITLE_MONSTER_SOLO_Champion;
	public static String TITLE_MONSTER_SOLO_Tyra;	
	...
	public static int BAIUM_DESPAWN_TIMEOUT;	
	...
	public static boolean ALT_OLY_UNLIMITED_TEST_MODE;
	...
	/** Elysian Realms Rebirth Manager */
	...
	public static boolean ALLOW_PLAYER_WALK_THROUGH_IN_PEACE_ZONE;
	public static int UNSTUCK_SECONDS;
	...
	//----------------------------------------
	/** Sieges */
	public static boolean ENABLE_REWARD_WINNER_CLAN;
	public static int[][] REWARD_WINNER_SIEGE_CLAN;
	public static int[][] LEADER_REWARD_WINNER_SIEGE_CLAN;
	public static boolean REMOVE_SIEGE_REWARD_ON_LOSE;
	public static boolean CLEAR_SIEGE_REGISTRATIONS_WHEN_DISABLED;
	public static boolean FORCE_RESYNC_SIEGE_DATE_ON_STARTUP;
	public static boolean SYNC_AUTO_SIEGE_CLANS_TO_CONFIG;
	public static boolean ENABLE_SIEGE_GUARDS_SPAWN;
	public static int SIEGE_LENGTH;
	public static int SIEGE_REGISTRATION_TIME;
	...
	public static int SIEGE_MINUTE_GLUDIO;
	public static int SIEGE_MINUTE_DION;
	public static int SIEGE_MINUTE_GIRAN;
	public static int SIEGE_MINUTE_OREN;
	public static int SIEGE_MINUTE_ADEN;
	public static int SIEGE_MINUTE_INNADRIL;
	public static int SIEGE_MINUTE_GODDARD;
	public static int SIEGE_MINUTE_RUNE;
	public static int SIEGE_MINUTE_SCHUT;
	...
	public static String SIEGE_AUTO_ATTACKERS_GLUDIO;
	public static String SIEGE_AUTO_ATTACKERS_DION;
	public static String SIEGE_AUTO_ATTACKERS_GIRAN;
	public static String SIEGE_AUTO_ATTACKERS_OREN;
	public static String SIEGE_AUTO_ATTACKERS_ADEN;
	public static String SIEGE_AUTO_ATTACKERS_INNADRIL;
	public static String SIEGE_AUTO_ATTACKERS_GODDARD;
	public static String SIEGE_AUTO_ATTACKERS_RUNE;
	public static String SIEGE_AUTO_ATTACKERS_SCHUT;
	public static String SIEGE_AUTO_DEFENDERS_GLUDIO;
	public static String SIEGE_AUTO_DEFENDERS_DION;
	public static String SIEGE_AUTO_DEFENDERS_GIRAN;
	public static String SIEGE_AUTO_DEFENDERS_OREN;
	public static String SIEGE_AUTO_DEFENDERS_ADEN;
	public static String SIEGE_AUTO_DEFENDERS_INNADRIL;
	public static String SIEGE_AUTO_DEFENDERS_GODDARD;
	public static String SIEGE_AUTO_DEFENDERS_RUNE;
	public static String SIEGE_AUTO_DEFENDERS_SCHUT;
	...
	/**
	 * If true - only VIP can change name/title color (regardless of COLOR_WITH_ITEM).
	 */
	public static boolean COLOR_REQUIRES_VIP_FOR_COLOR;
	...
	public static boolean RAIDBOSS_HP_ANNOUNCE;
	...
	public static String PLAYER_NAME_ALLOWED_CHARS;
	...
	/** custom droplist Champion Mobs */
	public static String CUSTOM_DROP_ITEM_Champion;
	public static List<Integer> CUSTOM_DROP_LIST_Champion;
	public static String CUSTOM_MONSTER_Champion;
	public static List<Integer> LIST_NPC_CUSTOM_MONSTER_Champion = new ArrayList<>();
	public static List<int[]> CUSTOM_MONSTER_DROP_Champion = new ArrayList<>();
	public static int DROP_PROTECTED_TIME_Champion;
	public static boolean CUSTOM_DROP_Champion;
	
	/** custom droplist Champion Mobs */
	public static String CUSTOM_DROP_ITEM_Tyra;
	public static List<Integer> CUSTOM_DROP_LIST_Tyra;
	public static String CUSTOM_MONSTER_Tyra;
	public static List<Integer> LIST_NPC_CUSTOM_MONSTER_Tyra = new ArrayList<>();
	public static List<int[]> CUSTOM_MONSTER_DROP_Tyra = new ArrayList<>();
	public static int DROP_PROTECTED_TIME_TYRA;
	public static boolean CUSTOM_DROP_Tyra;			
	...
	public static int DailyRewardOnlineMinutes;
	public static boolean DAILY_REWARD_HWID_PROTECT;
	public static boolean DAILY_REWARD_IP_PROTECT;
	public static boolean DAILY_REWARD_MULTIWINDOW_PROTECT;
	...
	public static int COUNT_PVP_ARCHERS;
	...
	/** Boss Event */
	public static boolean BOSS_EVENT_ENABLED;
	...
	public static int ANNOUNCE_ONLINE_PLAYERS_DELAY;
	 ...
	 // =============================================
	 // AUTO DATABASE BACKUP CONFIGURATION
	 // =============================================

	 // Enable or disable automatic database backups
	 public static boolean AUTO_BACKUP_ENABLE;
	 // Full path to mariadb-dump or mysqldump
	 // Leave empty to auto-detect
	 public static String AUTO_BACKUP_DUMP_PATH;
	 // Database settings
	 public static String AUTO_BACKUP_DB_HOST;
	 public static int AUTO_BACKUP_DB_PORT;
	 public static String AUTO_BACKUP_DB_USER;
	 public static String AUTO_BACKUP_DB_PASSWORD;
	 public static String AUTO_BACKUP_DB_NAME;
	 // Backup folder (relative to server root)
	 public static String AUTO_BACKUP_FOLDER;
	 // Interval backup in minutes, 0 to disable
	 public static int AUTO_BACKUP_INTERVAL_MINUTES;
	 // Daily backup time (24h format)
	 public static String AUTO_BACKUP_DAILY_TIME;
	 // Delete backups older than X days
	 public static int AUTO_BACKUP_DELETE_OLDER_THAN_DAYS;
	 // Discord webhook URL (leave empty to disable)
	 public static String AUTO_BACKUP_DISCORD_WEBHOOK;
	 // Zip backup? true/false
	 public static boolean AUTO_BACKUP_ZIP;
	 
	// ** Timed Items ** //
	 public static boolean ENABLE_TIMED_ITEMS;
	 public static String TIMED_ITEMS_LIST;
	 public static List<Integer> LIST_TIMED_ITEMS;
	 public static int TIMED_ITEM_TIME; // default duration in hours
	 public static Map<Integer, Integer> TIMED_ITEM_CUSTOM_TIME; // itemId -> custom duration
	 public static boolean TIMED_ITEM_BLOCK_TRADE;
	 public static boolean TIMED_ITEM_BLOCK_DROP;
	 public static boolean TIMED_ITEM_BLOCK_WAREHOUSE;
	 public static int TIMED_ITEM_CHECK_INTERVAL; // in seconds
	 public static int TIMED_ITEM_HTML_INTERVAL_MINUTES;
	 
	 public static String[] DAILY_REWARD_RESET_TIME;
	 public static boolean ENABLE_REWARD_DAILY;
	 
	// ** Race Of War ** //
	 public static boolean ENABLE_RACE_OF_WAR;
	 public static List<String> RACE_OF_WAR_START_TIMES;
	 public static int RACE_OF_WAR_DURATION_MIN;
	 public static int RACE_OF_WAR_REWARD_ID;
	 public static int RACE_OF_WAR_REWARD_COUNT;
	 
	// Random Fight
	 public static boolean ALLOW_RANDOM_FIGHT;
	 public static int RANDOM_FIGHT_EVERY_MINUTES;
	 public static int RANDOM_FIGHT_REGISTER_TIME;
	 public static int RANDOM_FIGHT_FIGHT_TIME;
	 public static boolean RANDOM_FIGHT_ALLOW_FAKES;
	 public static int RANDOM_FIGHT_FAKES_JOIN_CHANCE;
	 public static int[] RANDOM_FIGHT_REWARD_IDS;
	 public static long[] RANDOM_FIGHT_REWARD_COUNTS;
	 public static int RANDOM_FIGHT_X;
	 public static int RANDOM_FIGHT_Y;
	 public static int RANDOM_FIGHT_Z;
	 
	 // Suck stuck configs
	 public static boolean ENABLE_SUBCLASS_ACCUMULATIVE;
	 
	 // Anonymous PvP Event
	 public static boolean ANONYMOUS_PVP_EVENT_AUTO;
	 public static String[] ANONYMOUS_PVP_EVENT_INTERVAL;
	 public static boolean ANONYMOUS_PVP_ALLOW_DUALBOX;
	 public static int ANONYMOUS_PVP_MAX_CLIENTS_PER_PC;
	 public static String EVENT_ANONYMOUS_SKINS;
	 // Premiações do Anonymous PvP Event
	 public static int ANONYMOUS_PVP_REWARD_TOKEN_ID;
	 public static int ANONYMOUS_PVP_REWARD_FIRST;
	 public static int ANONYMOUS_PVP_REWARD_SECOND;
	 public static int ANONYMOUS_PVP_REWARD_THIRD;
	 public static String[] EVENT_ANONYMOUS_RACES;
	// Anonymous PvP - Kill Streak Enchant
	 public static boolean ANONYMOUS_PVP_ENABLE_ENCHANT;
	 public static int ANONYMOUS_PVP_KILLS_FOR_ENCHANT;
	 public static int ANONYMOUS_PVP_EVENT_ENCHANT_WEAPON_MAX;
	 public static int ANONYMOUS_PVP_EVENT_ENCHANT_ARMOR_MAX;
	 public static int ANONYMOUS_PVP_EVENT_ENCHANT_JEWELRY_MAX;
	 public static int ANONYMOUS_PVP_EVENT_ENCHANT_CHANCE;
	 public static boolean ZAKEN_DOOR_ALWAYS_OPEN = false;
	 ...
	 private static void loadRandomFight()
	 {
	     String FILE = "config/custom/events/randomFight.properties";
	     ExProperties prop = initProperties(FILE);

	     ALLOW_RANDOM_FIGHT = prop.getProperty("AllowRandomFight", false);
	     RANDOM_FIGHT_EVERY_MINUTES = prop.getProperty("EveryMinutes", 30);
	     RANDOM_FIGHT_REGISTER_TIME = prop.getProperty("RegisterDuration", 60);
	     RANDOM_FIGHT_FIGHT_TIME = prop.getProperty("FightDuration", 300);
	     RANDOM_FIGHT_ALLOW_FAKES = prop.getProperty("AllowFakes", false);
	     RANDOM_FIGHT_FAKES_JOIN_CHANCE = prop.getProperty("FakesJoinChance", 50);

	     RANDOM_FIGHT_X = prop.getProperty("FightX", 113474);
	     RANDOM_FIGHT_Y = prop.getProperty("FightY", 15552);
	     RANDOM_FIGHT_Z = prop.getProperty("FightZ", -3968);

	     String rewardIds = prop.getProperty("RewardIds", "8762");
	     String rewardCounts = prop.getProperty("RewardCounts", "5");

	     RANDOM_FIGHT_REWARD_IDS = parseIntArray(rewardIds);
	     RANDOM_FIGHT_REWARD_COUNTS = parseLongArray(rewardCounts);

	     // 🔐 SAFETY CHECK
	     if (RANDOM_FIGHT_REWARD_IDS.length != RANDOM_FIGHT_REWARD_COUNTS.length)
	     {
	         _log.warning("RandomFight: RewardIds count != RewardCounts count. Rewards disabled!");
	         RANDOM_FIGHT_REWARD_IDS = new int[0];
	         RANDOM_FIGHT_REWARD_COUNTS = new long[0];
	     }
	 }
	 ...
	 private static final void loadRaceOfWar()
	 {
	     String RACE_OF_WAR_FILE = "config/custom/events/raceOfWar.properties";
	     ExProperties raceProps = initProperties(RACE_OF_WAR_FILE);

	     ENABLE_RACE_OF_WAR = raceProps.getProperty("EnableRaceOfWar", false);
	     RACE_OF_WAR_DURATION_MIN = raceProps.getProperty("RaceOfWarDurationMin", 30);

	     RACE_OF_WAR_REWARD_ID = raceProps.getProperty("RaceOfWarRewardId", 8762);
	     RACE_OF_WAR_REWARD_COUNT = raceProps.getProperty("RaceOfWarRewardCount", 5);

	     // load start times
	     RACE_OF_WAR_START_TIMES = new ArrayList<>();
	     String times = raceProps.getProperty("StartTimes", "20:00");
	     for (String time : times.split(";"))
	     {
	         time = time.trim();
	         if (!time.isEmpty())
	             RACE_OF_WAR_START_TIMES.add(time);
	     }
	 }

	 

	 /** Loads TimedItem settings from dedicated properties file */
	 private static final void loadTimedItems()
	 {
	     String TIMEDITEM_FILE = "config/custom/timeditems.properties";
	     ExProperties timedProps = initProperties(TIMEDITEM_FILE);

	     ENABLE_TIMED_ITEMS = timedProps.getProperty("EnableTimedItems", false);
	     TIMED_ITEM_HTML_INTERVAL_MINUTES = timedProps.getProperty("HtmlPopupIntervalMinutes", 10);

	     TIMED_ITEMS_LIST = timedProps.getProperty("ListOfTimedItems", "57,4037,6673").trim();
	     LIST_TIMED_ITEMS = new ArrayList<>();
	     for (String id : TIMED_ITEMS_LIST.split(","))
	     {
	         try
	         {
	         ...
	         {
	             _log.warning("[Config.loadTimedItems()]: invalid itemId -> " + id);
	         }
	     }

	     TIMED_ITEM_TIME = timedProps.getProperty("TimedItemTime", 2);

	     TIMED_ITEM_CUSTOM_TIME = new HashMap<>();
	     String custom = timedProps.getProperty("TimedItemCustomTime", "");
	     if (!custom.isEmpty())
	     {
	         String[] pairs = custom.split(";");
	         for (String pair : pairs)
	         {
	             try
	             {
	                 ...
	                 if (split.length == 2)
	                     TIMED_ITEM_CUSTOM_TIME.put(
	                         Integer.parseInt(split[0].trim()),
	                         Integer.parseInt(split[1].trim()));
	                 else
	                     _log.warning("[Config.loadTimedItems()]: invalid TimedItemCustomTime -> " + pair);
	             }
	             catch (NumberFormatException nfe)
	             {
	                 _log.warning("[Config.loadTimedItems()]: invalid TimedItemCustomTime -> " + pair);
	     ...
	     TIMED_ITEM_BLOCK_TRADE = timedProps.getProperty("BlockTrade", false);
	     TIMED_ITEM_BLOCK_DROP = timedProps.getProperty("BlockDrop", false);
	     TIMED_ITEM_BLOCK_WAREHOUSE = timedProps.getProperty("BlockWarehouse", false);

	     TIMED_ITEM_CHECK_INTERVAL = timedProps.getProperty("CheckInterval", 60);
	 }
	 ...
	 * Loads AutoBackup settings from a dedicated properties file.
	   */
	   private static final void loadAutoBackup()
	   {
	   // Path to your AutoBackup properties file
	   String AUTO_BACKUP_FILE = "config/custom/autobackup.properties";
	   ExProperties autoBackupProps = initProperties(AUTO_BACKUP_FILE);

	   AUTO_BACKUP_ENABLE = autoBackupProps.getProperty("AUTO_BACKUP_ENABLE", false);
	   AUTO_BACKUP_DUMP_PATH = autoBackupProps.getProperty("AUTO_BACKUP_DUMP_PATH", "").trim();
	   AUTO_BACKUP_DB_HOST = autoBackupProps.getProperty("AUTO_BACKUP_DB_HOST", "localhost").trim();
	   AUTO_BACKUP_DB_PORT = autoBackupProps.getProperty("AUTO_BACKUP_DB_PORT", 3306);
	   AUTO_BACKUP_DB_USER = autoBackupProps.getProperty("AUTO_BACKUP_DB_USER", "root").trim();
	   AUTO_BACKUP_DB_PASSWORD = autoBackupProps.getProperty("AUTO_BACKUP_DB_PASSWORD", "").trim();
	   AUTO_BACKUP_DB_NAME = autoBackupProps.getProperty("AUTO_BACKUP_DB_NAME", "l2jdb").trim();

	   // Ensure folder path ends with file separator
	   String folder = autoBackupProps.getProperty("AUTO_BACKUP_FOLDER", "backups/sql/").trim();
	   if (!folder.endsWith("/") && !folder.endsWith(File.separator))
	   folder += File.separator;
	   AUTO_BACKUP_FOLDER = folder;

	   AUTO_BACKUP_INTERVAL_MINUTES = autoBackupProps.getProperty("AUTO_BACKUP_INTERVAL_MINUTES", 60);
	   AUTO_BACKUP_DAILY_TIME = autoBackupProps.getProperty("AUTO_BACKUP_DAILY_TIME", "04:00").trim();
	   AUTO_BACKUP_DELETE_OLDER_THAN_DAYS = autoBackupProps.getProperty("AUTO_BACKUP_DELETE_OLDER_THAN_DAYS", 7);
	   AUTO_BACKUP_DISCORD_WEBHOOK = autoBackupProps.getProperty("AUTO_BACKUP_DISCORD_WEBHOOK", "").trim();
	   AUTO_BACKUP_ZIP = autoBackupProps.getProperty("AUTO_BACKUP_ZIP", false);
	   }
	...
	public static List<int[]> SM_ITEM_REWARD = new ArrayList<>();


	private static final void SUPERMONSTER() 
	 {
	// Super Monster
	 ExProperties SuperMonster = initProperties(SUPERMONSTER_FILE);
	...
	private static final void loadBossEvent()
	{
		...
		BOSS_EVENT_ENABLED = bossEvent.getProperty("BossEventEnabled", false);
	...
	private static final void loadBoss()
	{
		...
		BAIUM_DESPAWN_TIMEOUT = boss.getProperty("BaiumDespawnTimeout", 30) * 60000;
		...
		ZAKEN_DOOR_ALWAYS_OPEN = boss.getProperty("ZakenDoorAlwaysOpen", false);
	...
	private static final void loadEvents()
	{
		...
		ALT_OLY_UNLIMITED_TEST_MODE = events.getProperty("AltOlyUnlimitedTestMode", false);
	    ...
	    // No método loadEvents():
	    ANONYMOUS_PVP_EVENT_AUTO = events.getProperty("AnonymousPvPEventAuto", false);
	    ANONYMOUS_PVP_ALLOW_DUALBOX = events.getProperty("AnonymousPvPAllowDualBox", false);
	    ANONYMOUS_PVP_MAX_CLIENTS_PER_PC = Integer.parseInt(events.getProperty("AnonymousPvPMaxClientsPerPC", "1"));
	    ANONYMOUS_PVP_EVENT_INTERVAL = events.getProperty("AnonymousPvPEventInterval", "12:00,18:00,21:00").split(",");
	    EVENT_ANONYMOUS_SKINS = events.getProperty("AnonymousEventSkins", "");
	    // Anonymous PvP Event: Premiações
	    ANONYMOUS_PVP_REWARD_TOKEN_ID = events.getProperty("AnonymousPvPRewardTokenId", 9605);
	    ANONYMOUS_PVP_REWARD_FIRST = events.getProperty("AnonymousPvPRewardFirst", 30);
	    ANONYMOUS_PVP_REWARD_SECOND = events.getProperty("AnonymousPvPRewardSecond", 20);
	    ANONYMOUS_PVP_REWARD_THIRD = events.getProperty("AnonymousPvPRewardThird", 15);
	    String races = events.getProperty("AnonymousEventRaces", "1,3");
	    EVENT_ANONYMOUS_RACES = races != null ? races.split(",") : new String[]{"1","3"};
	    ANONYMOUS_PVP_ENABLE_ENCHANT = events.getProperty("AnonymousPvPEnableEnchant", false);
	    ANONYMOUS_PVP_KILLS_FOR_ENCHANT = events.getProperty("AnonymousPvPKillsForEnchant", 5);
	    ANONYMOUS_PVP_EVENT_ENCHANT_WEAPON_MAX = Integer.parseInt(events.getProperty("AnonymousPvPEventEnchantWeaponMax", "25"));
        ANONYMOUS_PVP_EVENT_ENCHANT_ARMOR_MAX = Integer.parseInt(events.getProperty("AnonymousPvPEventEnchantArmorMax", "25"));
	    ANONYMOUS_PVP_EVENT_ENCHANT_JEWELRY_MAX = Integer.parseInt(events.getProperty("AnonymousPvPEventEnchantJewelryMax", "25"));
	   ANONYMOUS_PVP_EVENT_ENCHANT_CHANCE = Integer.parseInt(events.getProperty("AnonymousPvPEventEnchantChance", "100"));
	...
	private static final void loadOptions()
	{
		...
		TOP_PLAYER_ROW_HEIGHT = options.getProperty("TopPlayerRowHeight", 19);
		TOP_PLAYER_RESULTS = options.getProperty("TopPlayerResults", 15);
		BBS_DEFAULT = options.getProperty("BBSDefault", "_bbshome");
		
		ENABLE_REWARD_DAILY = Boolean.parseBoolean(options.getProperty("EnableRewardDaily", "false"));
		DAILY_REWARD_RESET_TIME = options.getProperty("DailyRewardResetTime", "20:00").split(":");
		DailyRewardOnlineMinutes = options.getProperty("DailyRewardOnlineMinutes", 720);
		DAILY_REWARD_HWID_PROTECT = Boolean.parseBoolean(options.getProperty("DailyRewardHwidProtect", "true"));
		DAILY_REWARD_IP_PROTECT = Boolean.parseBoolean(options.getProperty("DailyRewardIpProtect", "true"));
		DAILY_REWARD_MULTIWINDOW_PROTECT = Boolean.parseBoolean(options.getProperty("DailyRewardMultiWindowProtect", "true"));
	...
	private static final void loadPlayers()
	{
		...
		ALLOW_PLAYER_WALK_THROUGH_IN_PEACE_ZONE = players.getProperty("AllowPlayerWalkThroughInPeaceZone", false);
		UNSTUCK_SECONDS = players.getProperty("UnstuckSeconds", 30);
	...
	private static final void loadSieges()
	{
		...
		ENABLE_REWARD_WINNER_CLAN = Boolean.parseBoolean(sieges.getProperty("EnableRewardWinnerClan", "false"));
		...
		REMOVE_SIEGE_REWARD_ON_LOSE = Boolean.parseBoolean(sieges.getProperty("RemoveSiegeRewardOnLose", "false"));
		CLEAR_SIEGE_REGISTRATIONS_WHEN_DISABLED = Boolean.parseBoolean(sieges.getProperty("ClearSiegeRegistrationsWhenDisabled", "false"));
		FORCE_RESYNC_SIEGE_DATE_ON_STARTUP = Boolean.parseBoolean(sieges.getProperty("ForceResyncSiegeDateOnStartup", "false"));
		SYNC_AUTO_SIEGE_CLANS_TO_CONFIG = Boolean.parseBoolean(sieges.getProperty("SyncAutoSiegeClansToConfig", "true"));
		ENABLE_SIEGE_GUARDS_SPAWN = Boolean.parseBoolean(sieges.getProperty("EnableSiegeGuardsSpawn", "true"));
		
		SIEGE_LENGTH = sieges.getProperty("SiegeLength", 120);
		SIEGE_REGISTRATION_TIME = sieges.getProperty("SiegeRegistrationTime", 1440);
		...
		ATTACKERS_RESPAWN_DELAY = sieges.getProperty("AttackerRespawnSeconds", sieges.getProperty("AttackerRespawn", 10000) / 1000) * 1000;
		
		DAY_TO_SIEGE = Integer.parseInt(sieges.getProperty("WeeksToNextSiege", sieges.getProperty("DayToSiege", "2")));
		
		SIEGE_HOUR_GLUDIO = parseSiegeHour(sieges, "HourToSiege_Gludio", "16");
		SIEGE_HOUR_DION = parseSiegeHour(sieges, "HourToSiege_Dion", "16");
		SIEGE_HOUR_GIRAN = parseSiegeHour(sieges, "HourToSiege_Giran", "16");
		SIEGE_HOUR_OREN = parseSiegeHour(sieges, "HourToSiege_Oren", "16");
		SIEGE_HOUR_ADEN = parseSiegeHour(sieges, "HourToSiege_Aden", "16");
		SIEGE_HOUR_INNADRIL = parseSiegeHour(sieges, "HourToSiege_Innadril", "16");
		SIEGE_HOUR_GODDARD = parseSiegeHour(sieges, "HourToSiege_Goddard", "16");
		SIEGE_HOUR_RUNE = parseSiegeHour(sieges, "HourToSiege_Rune", "16");
		SIEGE_HOUR_SCHUT = parseSiegeHour(sieges, "HourToSiege_Schuttgart", "16");
		SIEGE_MINUTE_GLUDIO = parseSiegeMinute(sieges, "HourToSiege_Gludio", "MinuteToSiege_Gludio");
		SIEGE_MINUTE_DION = parseSiegeMinute(sieges, "HourToSiege_Dion", "MinuteToSiege_Dion");
		SIEGE_MINUTE_GIRAN = parseSiegeMinute(sieges, "HourToSiege_Giran", "MinuteToSiege_Giran");
		SIEGE_MINUTE_OREN = parseSiegeMinute(sieges, "HourToSiege_Oren", "MinuteToSiege_Oren");
		SIEGE_MINUTE_ADEN = parseSiegeMinute(sieges, "HourToSiege_Aden", "MinuteToSiege_Aden");
		SIEGE_MINUTE_INNADRIL = parseSiegeMinute(sieges, "HourToSiege_Innadril", "MinuteToSiege_Innadril");
		SIEGE_MINUTE_GODDARD = parseSiegeMinute(sieges, "HourToSiege_Goddard", "MinuteToSiege_Goddard");
		SIEGE_MINUTE_RUNE = parseSiegeMinute(sieges, "HourToSiege_Rune", "MinuteToSiege_Rune");
		SIEGE_MINUTE_SCHUT = parseSiegeMinute(sieges, "HourToSiege_Schuttgart", "MinuteToSiege_Schuttgart");
		...
		SIEGE_AUTO_ATTACKERS_GLUDIO = sieges.getProperty("AutoSiegeAttackers_Gludio", "");
		SIEGE_AUTO_ATTACKERS_DION = sieges.getProperty("AutoSiegeAttackers_Dion", "");
		SIEGE_AUTO_ATTACKERS_GIRAN = sieges.getProperty("AutoSiegeAttackers_Giran", "");
		SIEGE_AUTO_ATTACKERS_OREN = sieges.getProperty("AutoSiegeAttackers_Oren", "");
		SIEGE_AUTO_ATTACKERS_ADEN = sieges.getProperty("AutoSiegeAttackers_Aden", "");
		SIEGE_AUTO_ATTACKERS_INNADRIL = sieges.getProperty("AutoSiegeAttackers_Innadril", "");
		SIEGE_AUTO_ATTACKERS_GODDARD = sieges.getProperty("AutoSiegeAttackers_Goddard", "");
		SIEGE_AUTO_ATTACKERS_RUNE = sieges.getProperty("AutoSiegeAttackers_Rune", "");
		SIEGE_AUTO_ATTACKERS_SCHUT = sieges.getProperty("AutoSiegeAttackers_Schuttgart", "");
		SIEGE_AUTO_DEFENDERS_GLUDIO = sieges.getProperty("AutoSiegeDefenders_Gludio", "");
		SIEGE_AUTO_DEFENDERS_DION = sieges.getProperty("AutoSiegeDefenders_Dion", "");
		SIEGE_AUTO_DEFENDERS_GIRAN = sieges.getProperty("AutoSiegeDefenders_Giran", "");
		SIEGE_AUTO_DEFENDERS_OREN = sieges.getProperty("AutoSiegeDefenders_Oren", "");
		SIEGE_AUTO_DEFENDERS_ADEN = sieges.getProperty("AutoSiegeDefenders_Aden", "");
		SIEGE_AUTO_DEFENDERS_INNADRIL = sieges.getProperty("AutoSiegeDefenders_Innadril", "");
		SIEGE_AUTO_DEFENDERS_GODDARD = sieges.getProperty("AutoSiegeDefenders_Goddard", "");
		SIEGE_AUTO_DEFENDERS_RUNE = sieges.getProperty("AutoSiegeDefenders_Rune", "");
		SIEGE_AUTO_DEFENDERS_SCHUT = sieges.getProperty("AutoSiegeDefenders_Schuttgart", "");
		
	}

	private static int parseSiegeHour(ExProperties sieges, String hourKey, String defaultHour)
	{
		final String raw = sieges.getProperty(hourKey, defaultHour).trim();
		final String hourPart = raw.contains(":") ? raw.substring(0, raw.indexOf(':')).trim() : raw;
		return parseBoundedInt(hourPart, 0, 23, Integer.parseInt(defaultHour), hourKey);
	}

	private static int parseSiegeMinute(ExProperties sieges, String hourKey, String minuteKey)
	{
		final String raw = sieges.getProperty(hourKey, "16").trim();
		if (raw.contains(":"))
		{
			final String minutePart = raw.substring(raw.indexOf(':') + 1).trim();
			return parseBoundedInt(minutePart, 0, 59, 0, hourKey);
		}
		return parseBoundedInt(sieges.getProperty(minuteKey, "0").trim(), 0, 59, 0, minuteKey);
	}

	private static int parseBoundedInt(String raw, int min, int max, int fallback, String keyName)
	{
		try
		{
		...
		{
			_log.warning("Invalid integer value '" + raw + "' for " + keyName + ". Using " + fallback + ".");
			return fallback;
		}
	}
	
	public static List<Integer> getAutoSiegeClanIds(int castleId, boolean attackers)
	{
		final String raw;
		switch (castleId)
		{
			case 1: raw = attackers ? SIEGE_AUTO_ATTACKERS_GLUDIO : SIEGE_AUTO_DEFENDERS_GLUDIO; break;
			case 2: raw = attackers ? SIEGE_AUTO_ATTACKERS_DION : SIEGE_AUTO_DEFENDERS_DION; break;
			case 3: raw = attackers ? SIEGE_AUTO_ATTACKERS_GIRAN : SIEGE_AUTO_DEFENDERS_GIRAN; break;
			case 4: raw = attackers ? SIEGE_AUTO_ATTACKERS_OREN : SIEGE_AUTO_DEFENDERS_OREN; break;
			case 5: raw = attackers ? SIEGE_AUTO_ATTACKERS_ADEN : SIEGE_AUTO_DEFENDERS_ADEN; break;
			case 6: raw = attackers ? SIEGE_AUTO_ATTACKERS_INNADRIL : SIEGE_AUTO_DEFENDERS_INNADRIL; break;
			case 7: raw = attackers ? SIEGE_AUTO_ATTACKERS_GODDARD : SIEGE_AUTO_DEFENDERS_GODDARD; break;
			case 8: raw = attackers ? SIEGE_AUTO_ATTACKERS_RUNE : SIEGE_AUTO_DEFENDERS_RUNE; break;
			case 9: raw = attackers ? SIEGE_AUTO_ATTACKERS_SCHUT : SIEGE_AUTO_DEFENDERS_SCHUT; break;
			default: raw = "";
		}
		...
		for (String part : raw.split(","))
		{
			...
			{
				_log.warning("Invalid auto siege clan id '" + value + "' for castleId=" + castleId + ", attackers=" + attackers);
			}
		}
		return result;
	}
	...
	private static final void loadSkills()
	{
		...
		ENABLE_SUBCLASS_ACCUMULATIVE = Boolean.parseBoolean(skills.getProperty("EnableSubClassAccumulative", "false"));
	...
	private static final void loadL2JMega()
	{
		...
		ALLOW_ZONE_NAME = Boolean.parseBoolean(l2jmega.getProperty("EnableZoneNameCharacter", "false"));
		ZONE_NAME = l2jmega.getProperty("CharacterNameZone", "Aio");
		...
		// SKIN_ANIMATION_TIME moved to SkinEnhancements.ini
		SKIN_SKILL_ID = Integer.parseInt(l2jmega.getProperty("SkinSkillId", "1036"));
		SKIN_ENABLE_ANIMATIONS = Boolean.parseBoolean(l2jmega.getProperty("EnableSkinAnimations", "True"));
		
		loadSkinEnhancements();
		...
		GLOBAL_DROP = l2jmega.getProperty("DropSystem", false);
		String[] temp = l2jmega.getProperty("DropList", "").split(";");
		for (String s : temp)
		{
		...
		PLAYER_NAME_ALLOWED_CHARS = l2jmega.getProperty("AllowedPlayerNameChars", "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789()-*_[].{}");
		...
		ALLOW_ANNOUNCE_ONLINE_PLAYERS = Boolean.parseBoolean(l2jmega.getProperty("AllowAnnounceOnlinePlayers", "True"));
		ANNOUNCE_ONLINE_PLAYERS_DELAY = Integer.parseInt(l2jmega.getProperty("AnnounceOnlinePlayersDelay", "300"));

        
		PROTECTION_HEAL = l2jmega.getProperty("HealProtection", false);
		PLAYERS_CAN_HEAL_RB = l2jmega.getProperty("HealRaidBosessProtection", false);
		PROTECTION_HEAL_PVP = l2jmega.getProperty("HealCurrent", 1.);
		...
		//----------------------------------------
				//  New Test Mod Drops champ
				//----------------------------------------
				TITLE_MONSTER_SOLO_Champion = l2jmega.getProperty("Title_MonsterFarm_Champ", "");
				CUSTOM_DROP_Champion = Boolean.parseBoolean(l2jmega.getProperty("CustomDrop_Champ", "False"));
				CUSTOM_DROP_ITEM_Champion = l2jmega.getProperty("CustomDropItens_Champ", "");
				CUSTOM_DROP_LIST_Champion = new ArrayList<>();
				for (String itemId : CUSTOM_DROP_ITEM_Champion.split(","))
				{
				CUSTOM_DROP_LIST_Champion.add(Integer.parseInt(itemId));
				}
						
				CUSTOM_MONSTER_Champion = l2jmega.getProperty("List_Monster_Champ", "0");
				LIST_NPC_CUSTOM_MONSTER_Champion = new ArrayList<>();
				for (String listid : CUSTOM_MONSTER_Champion.split(","))
				{
				LIST_NPC_CUSTOM_MONSTER_Champion.add(Integer.parseInt(listid));
				}
				
				
				
				String[] p = l2jmega.getProperty("DropList_Monster_Champ", "57,0").split(";");
				CUSTOM_MONSTER_DROP_Champion.clear();
				for (String reward : p)
				{
				String[] rewardSplit = reward.split(",");
				if (rewardSplit.length != 2)
				...
				else
				{
					try
						{
						CUSTOM_MONSTER_DROP_Champion.add(new int[]
						{
							Integer.parseInt(rewardSplit[0]),
							Integer.parseInt(rewardSplit[1])
						});
				...
				//----------------------------------------
				//  New Test Mod Drops champ End Code
				//----------------------------------------
				
				//----------------------------------------
						//  New Test Mod Drops champ
						//----------------------------------------
						TITLE_MONSTER_SOLO_Tyra = l2jmega.getProperty("Title_MonsterFarm_Tyra", "");
						CUSTOM_DROP_Tyra = Boolean.parseBoolean(l2jmega.getProperty("CustomDrop_Tyra", "False"));
						CUSTOM_DROP_ITEM_Tyra = l2jmega.getProperty("CustomDropItens_Tyra", "");
						CUSTOM_DROP_LIST_Tyra = new ArrayList<>();
						for (String itemId : CUSTOM_DROP_ITEM_Tyra.split(","))
						{
						CUSTOM_DROP_LIST_Tyra.add(Integer.parseInt(itemId));
						}
								
						CUSTOM_MONSTER_Tyra = l2jmega.getProperty("List_Monster_Tyra", "0");
						LIST_NPC_CUSTOM_MONSTER_Tyra = new ArrayList<>();
						for (String listid : CUSTOM_MONSTER_Tyra.split(","))
						{
						LIST_NPC_CUSTOM_MONSTER_Tyra.add(Integer.parseInt(listid));
						}
								
						String[] c = l2jmega.getProperty("DropList_Monster_Tyra", "57,0").split(";");
						CUSTOM_MONSTER_DROP_Tyra.clear();
						for (String reward : c)
						{
						String[] rewardSplit = reward.split(",");
						if (rewardSplit.length != 2)
						...
						else
						{
							try
								{
								CUSTOM_MONSTER_DROP_Tyra.add(new int[]
								{
									Integer.parseInt(rewardSplit[0]),
									Integer.parseInt(rewardSplit[1])
								});
		...
		DROP_PROTECTED_TIME_Champion = Integer.parseInt(l2jmega.getProperty("DropProtectedTime_Champion", "15"));
		DROP_PROTECTED_TIME = Integer.parseInt(l2jmega.getProperty("DropProtectedTime", "15"));
		DROP_PROTECTED_TIME_TYRA = Integer.parseInt(l2jmega.getProperty("DropProtectedTime_Tyra", "15"));
		...
		RESET_DAILY_TIME = l2jmega.getProperty("DailyRewardResetTime", "20:00").split(",");
		...
		// Backward/forward compatible key names:
		// - preferred: ColorWithVip
		// - legacy: ColorRequiresVipForColor
		COLOR_REQUIRES_VIP_FOR_COLOR = Boolean.parseBoolean(
			l2jmega.getProperty(
				"ColorWithVip",
				l2jmega.getProperty("ColorRequiresVipForColor", "false")));
		...
		RAIDBOSS_HP_ANNOUNCE = Boolean.parseBoolean(l2jmega.getProperty("RaidBossHpAnnounce", "false"));
	...
	private static final void load_Phantom()
	{
		...
		for (String itemId : PHANTOM_FACE.split(","))
		{
			...
			{
				_log.warning("Invalid PhantomFaceList value '" + itemId + "', skipping.");
			}
		}
		...
		for (String itemId : PHANTOM_HAIR.split(","))
		{
			...
			{
				_log.warning("Invalid PhantomHairList value '" + itemId + "', skipping.");
			}
		}
		...
		for (String itemId : CLAN_ID.split(","))
		{
			...
			{
				_log.warning("Invalid ClanIDList value '" + itemId + "', skipping.");
			}
		}
		...
		COUNT_PVP_ARCHERS = Phanton.getProperty("pvp_archers_count", 0);
	...
	/**
	 * load Auto farm Settings
	 */
	private static final void loadAutoFarm()
	{
		final ExProperties commands = initProperties(AUTO_FARM_FILE);
	...
	private static final void loadServer()
	{
		...
		DATABASE_URL = server.getProperty("URL", "jdbc:mysql://localhost/acis?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC");
	...
	public static final void loadGameServer()
	{
		...
		// Legacy PhantomPlayers.ini loader disabled.
		// Active fake player system uses FakePlayers.properties.
	...
	private static final void loadSkinEnhancements()
	{
		final ExProperties skinEnhancements = initProperties(SKIN_ENHANCEMENTS_FILE);
		SKIN_ANIMATION_TIME = Integer.parseInt(skinEnhancements.getProperty("SkinAnimationTime", "4000"));
		SKIN_ENABLE_ENHANCED_EFFECTS = Boolean.parseBoolean(skinEnhancements.getProperty("EnableEnhancedEffects", "True"));
		SKIN_ENABLE_SOUNDS = Boolean.parseBoolean(skinEnhancements.getProperty("EnableSkinSounds", "True"));
		SKIN_EFFECT_INTENSITY = Integer.parseInt(skinEnhancements.getProperty("SkinEffectIntensity", "5"));
		SKIN_ENABLE_MESSAGES = Boolean.parseBoolean(skinEnhancements.getProperty("EnableSkinMessages", "True"));
		SKIN_TRANSFORMATION_MESSAGE = skinEnhancements.getProperty("SkinTransformationMessage", "You have activated skin transformation!");
		SKIN_COOLDOWN_TIME = Integer.parseInt(skinEnhancements.getProperty("SkinCooldownTime", "0"));
		SKIN_ENABLE_ZONE_RESTRICTIONS = Boolean.parseBoolean(skinEnhancements.getProperty("EnableSkinZoneRestrictions", "False"));
		SKIN_ALLOWED_ZONES = skinEnhancements.getProperty("AllowedSkinZones", "TOWN,PEACE");
		SKIN_ENABLE_FOR_GM = Boolean.parseBoolean(skinEnhancements.getProperty("EnableSkinForGM", "True"));
		SKIN_ENABLE_FOR_AIO = Boolean.parseBoolean(skinEnhancements.getProperty("EnableSkinForAIO", "True"));
	}
}
